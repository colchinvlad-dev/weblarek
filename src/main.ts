...
// 2. Тестирование моделей (без изменений, кроме buyerModel.validate)
...
// 3. Запрос к серверу – теперь используется IApi
console.log('=== ЗАПРОС К СЕРВЕРУ ===');
const baseApi = new Api(API_URL);      // экземпляр класса Api, который реализует IApi
const api = new AppApi(baseApi);       // передаём его в AppApi
